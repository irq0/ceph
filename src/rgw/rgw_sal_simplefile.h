...
class SimpleFileZoneGroup : public ZoneGroup {
 ...
 public:
  SimpleFileZoneGroup(const SimpleFileStore &_store,
...
class SimpleFileZone : public Zone {
 ...
 public:
  ...
  SimpleFileZone(const SimpleFileStore& _store);
...
class SimpleFileStore : public Store {
 ...
 public:
  ...
  CephContext *ceph_context() const {
    return cctx;
  };

  virtual Zone *get_zone() override {
    return &zone;
  }
