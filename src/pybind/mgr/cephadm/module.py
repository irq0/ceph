...
DEFAULT_PROMETHEUS_IMAGE = 'registry.suse.com/ses/7.1/ceph/prometheus-server:2.37.6'
DEFAULT_NODE_EXPORTER_IMAGE = 'registry.suse.com/ses/7.1/ceph/prometheus-node-exporter:1.5.0'
DEFAULT_ALERT_MANAGER_IMAGE = 'registry.suse.com/ses/7.1/ceph/prometheus-alertmanager:0.23.0'
DEFAULT_GRAFANA_IMAGE = 'registry.suse.com/ses/7.1/ceph/grafana:8.5.22'
DEFAULT_HAPROXY_IMAGE = 'registry.suse.com/ses/7.1/ceph/haproxy:2.0.31'
