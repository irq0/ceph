...
void Server::handle_client_setattr(MDRequestRef& mdr)
{
  ...
  // xlock inode
  if (mask & (CEPH_SETATTR_MODE|CEPH_SETATTR_UID|CEPH_SETATTR_GID|CEPH_SETATTR_BTIME|CEPH_SETATTR_KILL_SGUID|CEPH_SETATTR_KILL_SUID|CEPH_SETATTR_KILL_SGID|CEPH_SETATTR_FSCRYPT_AUTH))
