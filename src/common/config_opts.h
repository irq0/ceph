...
OPTION(osd_pool_default_flag_hashpsonlyprefix, OPT_BOOL, false) // hash only prefix of object name for ps
...
OPTION(osd_pool_object_hash, OPT_INT, CEPH_STR_HASH_RJENKINS)
